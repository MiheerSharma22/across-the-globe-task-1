 ...
 function Modal ( {isLoggedIn , onClose} )  {
  ...
  return (
    !isLoggedIn && createPortal(
        // dark filter bg
        <div className='top-0 left-0 right-0 bottom-0 bg-[#00000088] absolute flex felx-col justify-center items-center min-w-[100%]  min-h-[100%] modal-dark-filter-bg'>
        {/* modal container */}
            <div className='bg-[#fff] w-[50%] h-[70%]  flex flex-col rounded-lg modal-container relative'>
                ...
                <div className='w-[90%] mx-auto flex gap-5 modal-content-container'>
                    ...
                    <div className='w-[50%] flex flex-col justify-between modal-right-part'>
                        <div className='flex flex-col items-end'>
                            ...
                            <img src={signUpImage} alt='createaccount' />
                        </div>
